...
oct_2005_data.Anomalia = nan(height(oct_2005_data), 1);

% Para las filas donde se encontró coincidencia, calcular la anomalía
oct_2005_data.Anomalia(found) = oct_2005_data.Chl(found) - oct_climatology.Chl_Climatology(idx(found));
...
output_table = table(oct_2005_data.Time, oct_2005_data.Latitude, oct_2005_data.Longitude, ...
                     oct_2005_data.Chl, oct_2005_data.Anomalia, ...
                     'VariableNames', {'Fecha', 'Latitud', 'Longitud', 'Chl', 'Anomalia'});

writetable(output_table, '/Volumes/LLACA/Posdoctorado/Gaby/anomalia_chl_octubre_2005.csv');

disp('La climatología mensual se ha guardado en "climatologia_chl_mensual.mat".');
disp('Las anomalías de Chl para octubre de 2005 se han guardado en "anomalia_chl_octubre_2005.csv".');
